...
public class GroupController {
    ...
    @GetMapping
    public List<GroupLightDto> getAllGroupsLight(Pageable pageable, @RequestParam(required = false) GroupSearchRequest filter) {
    ...
    @PostMapping
    public void createGroup(@RequestPart("data") GroupDto groupDto, @RequestPart("image") MultipartFile image) {
